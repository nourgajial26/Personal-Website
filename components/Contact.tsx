...
function Contact ({}: Props){
    ...
    {window.location.href=`mailto:nourgajial@gmail.com?subject=${formData.subject}&body= Hi, my name is ${formData.name}. ${formData.message} (Sent from ${formData.email}))`};
        ...
        <div className='flex flex-col space-y-10 mt-24'>
            ...
            <div className='space-y-10'>
                ...
                >
                    ...
                    <button 
                        type='submit' 
                        className='bg-[#493519] py-5 px-10 rounded-md font-bold'>
                        Submit
                    </button>
